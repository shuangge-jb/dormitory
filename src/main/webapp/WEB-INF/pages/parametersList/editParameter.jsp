...
<script type="text/javascript">
	...
	function keyPress() //textArea输入长度处理   
	 ...
	 function back(){
          var pageSize = 5;
          var pageIndex = 1;
          window.location.href ="<%=path%>/forwardParametersList.do?pageIndex="
...
<body>
	<div class="panel panel-success">
		...
		<div class="panel-body">
			<form
				action="<%=path %>/admin/updateParamater.do?pageIndex=${pageIndex}&pageSize=10"
				name="form1" method="post" onsubmit="return save();">
				...
				<div style="margin-left: 80px; margin-top: 30px;">
					<font color=red>*</font>参数名称：<input type="text" id="paramaterName"
						name="paramaterName" class="inputTxt"
						value="${data.paramaterName}" disabled="true">
				</div>
				<div style="margin-left: 80px; margin-top: 30px;">
				...
				<div class="button-group"  style="margin-left: 80px; margin-top: 10px;">
