...
<html>
  ...
  <body>
     <div style="margin-top:10px;margin-left:5px;">
            ...
            enctype="multipart/form-data" onsubmit="return verifyInterfaceInfo();">
			...
			<div style="margin-left:80px;margin-top:30px;">
				<font color=red>*</font> 功能的来源：<input type="text" 
					name="source" class="inputTxt" placeholder="如:学校的电费系统">
			</div>
			...
			<div style="margin-left:80px;margin-top:10px;">
				...
				<textArea 
					...
					class="textAreaTxt" placeholder="描述清楚该功能的作用"
				...
				onMouseOut="this.style.backgroundColor ='#0090DB';"/>&nbsp;
			     <input type="button" value="返回" onclick="back(${pageIndex},${device.deviceId},${backPageIndex})"
