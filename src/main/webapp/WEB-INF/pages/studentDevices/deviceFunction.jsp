...
#myDormitoryDevice{
 color:#fff;text-decoration:none;background-color:#0074A6;height:50px;line-height:51px;line-height:54px\9;line-height:52px\0;border-bottom:0;
  ...
  #brief{
  margin-top:20px;margin-left:40px;width:200;color=#333333;
  }
  #page{
   padding-top:10px;
   }
...
<a href="http://www.mb5u.com/ask/" target="_blank">站长问答</a>
	...
	<div id="backIt">
		<img src="<%=path%>/images/back.PNG;" /> 
			<font
			size=2 color=#DEEBF3 > 选<br> 其<br> 他<br> 设<br>
			备
		</font>
	</div>
	<div
		...
		<div
			...
			<div style="margin-left:40px;margin-top:25px;">
				<span class="deviceName">${device.name}</span><br>
		...
		<div style="float:left;">
			...
			<div style="width:650px;border:0.1px solid #D7D7D7;"></div>
				...
				<div
				style="height:40px;line-height:40px;border-bottom:#D7D7D7 1px dashed;">
                          <font size=2 color=#9F9FB2>查看费用使用情况</font>
