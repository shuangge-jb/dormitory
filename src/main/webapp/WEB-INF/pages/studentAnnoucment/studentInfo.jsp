...
<jsp:include page="title.jsp"></jsp:include>
 ...
 <div class="lostFond-form" style="min-height:380px;">
  ...
  <div style="float:left;">
     ...
     <ul>
     <li class="pb10">  
      <font color=#818181 size=4>学生姓名：</font> 
             <input type="text"  value="${student.name}" id="name"
					name="name" class="inputTxt" disabled="true"><br></li>
	 <li class="pb10"> <font color=#818181 size=4>宿舍楼：</font> 
             <input type="text"  value="${student.buildingName}" id="dormitoryId"
					name="buildingName" class="inputTxt" disabled="true"><br></li>
	<li class="pb10"><font color=#818181 size=4>房号：</font> 
             <input type="text"  value="${student.room}" id="room"
					name="room" class="inputTxt" disabled="true"><br></li>	
	
	<li class="pb10"><font color=#818181 size=4>电话号码：</font> 
             <input type="text"  value="${student.phoneNumber}" id="phoneNumber"
					name="phoneNumber" class="inputTxt" disabled="true"><br></li>	
   <li class="pb10"><font color=#818181 size=4>床号：</font>
   <select name="bedId" id="bedId" class="inputTxt" disabled="true"> 
			   <option value="1" <c:if test="${student.bedId==1}">selected</c:if>>1号</option>
			   <option value="2" <c:if test="${student.bedId==2}">selected</c:if>>2号</option>
			   <option value="3" <c:if test="${student.bedId==3}">selected</c:if>>3号</option>
			   <option value="4" <c:if test="${student.bedId==4}">selected</c:if>>4号</option>
			   </select>	
	 </li>
	 <li class="pb10"><font color=#818181 size=4>邮箱：</font> 
	...
	<li class="pb10">		 <font color=#818181 size=4>头像图片：</font> 
      ...
      <input type="button" value="编辑" onclick="edit();"
		...
		<div id="headImg" style="margin-top:20px;margin-left:420px;">
          <img src="${student.imgPath}" width="100px" height="120px" alt="userImg"/>
