...
<script type="text/javascript">
	...
	function keyPress() //textArea输入长度处理   
	{
		...
		{
			document.getElementById("description").value = description.substr(
					0, 100);
			len = 0;
		} else {
...
.repairSubmit {
	...
	height: 30px;
	position: relative;
	background: -webkit-linear-gradient(top, rgb(74, 162, 241),
		rgb(52, 119, 182)) 1px 0 no-repeat,
		-webkit-linear-gradient(top, rgb(52, 118, 181), rgb(36, 90, 141)) left
		top no-repeat;
...
<body>
	...
	<div id="nav">
		<div class="navc">
			<a href="<%=path%>/homePage.jsp">首页</a><em></em> <a
				href="<%=path%>/student/listUserDevice.do?pageIndex=1&pageSize=8">我的设备</a>
			<a href="#">失物招领</a><em></em> <a
				href="<%=path%>/student/listRepairRecordByDormitoryId.do?dormitoryId=${dormitoryId}&pageIndex=1&pageSize=2"
				id="repair">我的报修</a><em></em> <a href="#">宿舍明信片</a><em></em> <a
				href="#">虚拟宿舍</a><em></em> <a
				href="<%=path%>/listMyDormitoryAnnouncement.do?dormitoryId=${dormitoryId }&pageIndex=1&pageSize=10">最新公告</a><em></em>
			<a href="#">使用指南</a>
		</div>
	</div>
	<div class="register-main">
		<div class="register-form" style="min-height: 380px;">
			<h3 class="content-hd">
				<b>我的报修</b><label class="c_orange">(*可以查看报修记录和申请报修)</label>
			</h3>
			<div style="margin-left: 40px;">
				<input type="button" id="repairRecord" value="报修记录"
					onclick="goingRepairRecord();" /> <input type="button"
					id="applyRepair" value="现在报修" onclick="applyRepair();" />
			</div>
			<div
				style="border-bottom: 0.5px solid #009AFF; width: 790px; margin-left: 6px;"></div>
			<div>
				<span style="margin-left: 79px;"><font color="red">${status}</font></span>
			</div>
			<form action="<%=path%>/student/saveRepairRecord.do"
				onsubmit="return verifyRepairInfo();" name="form1" method="post">
				<ul class="form-content">
					<li class="pb10"><label class="form-label"> <b
							class="c_orange">*</b> 报修人Id：
					</label><input type="text" class="inputTxt" name="contactId" id="contactId" />
					</li>
					<li class="pb10"><label class="form-label"> <b
							class="c_orange">*</b> 维修设备：
					</label><input type="text" class="inputTxt" name="deviceName"
						id="deviceName" placeholder="填写坏的设备名称" /></li>
					<li class="pb10"><input type="hidden" name="dormitoryId"
						value="${dormitoryId }" /></li>
					<!-- <li class="pb10">
			  <label class="form-label">
			   ...
			   placeholder="填写清楚报修的宿舍" />
					...
					<li class="pb10"><label class="form-label"> <b
							class="c_orange">*</b> 维修简述：
					</label><input type="text" class="inputTxt" name="content" id="content"
						maxlength="15" /></li>
					<li class="pb10"><label class="form-label"> <b
							class="c_orange">*</b> 报修人号码：
					</label><input type="text" class="inputTxt" name="phoneNumber"
						id="phoneNumber" /></li>
				</ul>
