...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<style type="text/css">
		* {
		...
		body#login {
			background: url(/dormitory/images/master.jpg) repeat-x scroll 0 0;
		}
		body#index {
  ...
  <body id="login">
	<form action="<%=path%>/master/masterLogin.do" id="loginForm" name="loginForm" method="post" onsubmit="return check1();">
		<h3><img  src="<%=path %>/img/group.png" style="vertical-align:middle;height:20px;"/>&nbsp;虚拟宿舍宿管登陆</h3>
		<table align="center" border="0" cellpadding="9" cellspacing="9">
			<tr align='center'>
				...
				<td align="left">
					<input name="id" type="text" style="width: 200px;height: 20px;" value="${userName}"/>
				</td>
			</tr>
			<tr align='center'>
				<td style="width: 50px;font-family: 微软雅黑;" align="left">
		...
		<span style="text-align:center;"><font color=red>${status}</font></span>
	</form>
  </body>
</html>